...
### 📊 核心功能
- **智能记账**：AI自动分类，只需输入金额和描述
- **记录支出/收入**：支持快速记录日常消费和收入
- **多维度统计**：日统计、月统计、总统计、分类统计
- **详细记录查看**：查看所有记账记录的详细信息（含描述）
- **智能删除**：支持按序号删除指定账单
- **AI财务分析**：基于记账数据提供AI财务建议

### 🎯 特色功能
- **AI自动分类**：根据描述自动判断支出/收入类别
...
日统计 2024-02-25
```
显示指定日期的收支统计，默认显示今日统计，并提供AI财务建议。
...
月统计 2024-02
```
显示指定月份的收支统计，默认显示本月统计，并提供AI财务建议。

#### 6. 查看详细记录
```
查账详情
```
显示最近20条记账记录的详细信息，包括描述。

#### 7. 按类别统计
```
按类统计
```
显示支出和收入的分类统计，按金额排序，并提供AI财务建议。
...
### v1.1.0
- **AI自动分类**：根据描述自动判断支出/收入类别
- **简化记账命令**：去掉类别参数，只需输入金额和描述
- **添加description字段**：支持记录详细描述
- **优化数据结构**：去掉timestamp字段，只保留time字段
- **增强AI财务建议**：提供更详细的消费结构分析
